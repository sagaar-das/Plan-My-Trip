    ...
    return (
        <div className='mt-7' >
            ...
            <p className='text-center text-gray-500 mt-2'>
                Discover personalized travel itineraries, find the best destinations and plan your dream vocation effortlessly with the power of AI. Let our smart assistant do the hard work while you enjoy the journey. 
            </p>
